...
# create a general function to update all sheets with the processed information # refactoring# avoid repeating the same code
def update_worksheet(data, worksheet):        # workseet is a local var used for all sheets
...
#create a function to get an average for the last 6 days
...
def main():
    ...
    update_worksheet(sales_data, "sales")         # update the sheet with the new sale's day information
    ...
    sales_columns = get_last_6_entries_sales()              #calculate avaerage for last 6 days
